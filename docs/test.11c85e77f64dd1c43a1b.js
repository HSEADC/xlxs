...
;// CONCATENATED MODULE: ./src/images/testss/Q-Test-Res-1.png
const Q_Test_Res_1_namespaceObject = __webpack_require__.p + "images/Q-Test-Res-1.7eb48dc4f439f7ac91ac.png";
;// CONCATENATED MODULE: ./src/testss/test1.js
...
var stage = {
  ...
  answers: [{
    ...
    text: 'Коробка с барабаном',
    count: 0
  }]
};
var resultTable = {
  preview: 'Диаграммы размаха («ящик с усами») (Box and Whisker Plot или Box Plot) – это удобный способ визуального представления групп числовых данных через квартили. Диаграммы размаха, как правило, используются в описательной статистике и позволяют быстро исследовать один или более наборов данных.',
...
function showResult() {
  ...
  image.innerHTML = "<img src=".concat(Q_Test_Res_1_namespaceObject, ">");
