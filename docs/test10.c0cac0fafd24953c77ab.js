...
;// CONCATENATED MODULE: ./src/images/testss/Q-Test-Res-10.png
const Q_Test_Res_10_namespaceObject = __webpack_require__.p + "images/Q-Test-Res-10.654482a9c3a02986d739.png";
;// CONCATENATED MODULE: ./src/testss/test10.js

var stage = {
  question: 'В чем преимущество диаграммы с областями по сравнению с линейным графиком?',
  answers: [{
    text: 'Показывает процентное соотношение категорий',
    count: 0
  }, {
    text: 'Используется для отображения иерархий',
    count: 0
  }, {
    text: 'Показывает общую тенденцию данных с акцентом на объем',
    count: 1
  }, {
    text: 'Предназначена для отображения временных рядов',
    count: 0
  }]
};
var resultTable = {
  preview: 'Диаграмма с областями является важным инструментом в визуализации данных, позволяющим представить количественные данные через временные периоды или среди различных категорий. Этот тип диаграммы помогает аналитикам, исследователям и маркетологам эффективно анализировать тренды, сравнивать показатели и делать выводы на основе визуального представления данных.',
  text: 'Все верно!'
};
...
function showResult() {
  ...
  image.innerHTML = "<img src=".concat(Q_Test_Res_10_namespaceObject, ">");
  ...
  imageArticle.innerHTML = "<img src=".concat(Q_Test_Res_10_namespaceObject, ">");
