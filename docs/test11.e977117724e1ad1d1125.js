...
;// CONCATENATED MODULE: ./src/images/testss/Q-Test-Res-11.png
const Q_Test_Res_11_namespaceObject = __webpack_require__.p + "images/Q-Test-Res-11.f1332cc829cf4f1b7e0c.png";
;// CONCATENATED MODULE: ./src/testss/test11.js

var stage = {
  question: 'Чем кольцевая диаграмма отличается от круговой?',
  answers: [{
    text: 'Формой отображения данных',
    count: 0
  }, {
    text: 'Наличием центрального отверстия для доп. информации',
    count: 1
  }, {
    text: 'Возможностью отображения отрицательных значений',
    count: 0
  }, {
    text: 'Способом отображения временных данных',
    count: 0
  }]
};
var resultTable = {
  preview: 'Кольцевая диаграмма, также известная как донат-диаграмма (от англ. "donut chart"), представляет собой вариант круговой диаграммы. Основное отличие заключается в том, что в центре кольцевой диаграммы находится пустое пространство, делая её похожей на форму бублика. Эта особенность не только придает диаграмме уникальный визуальный стиль, но и позволяет размещать дополнительную информацию в центральной части.',
  text: 'Все верно!'
};
...
function showResult() {
  ...
  image.innerHTML = "<img src=".concat(Q_Test_Res_11_namespaceObject, ">");
  ...
  imageArticle.innerHTML = "<img src=".concat(Q_Test_Res_11_namespaceObject, ">");
