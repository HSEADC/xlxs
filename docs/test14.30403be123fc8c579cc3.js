...
;// CONCATENATED MODULE: ./src/images/testss/Q-Test-Res-14.png
const Q_Test_Res_14_namespaceObject = __webpack_require__.p + "images/Q-Test-Res-14.d1762f5183dea8b959ba.png";
;// CONCATENATED MODULE: ./src/testss/test14.js

var stage = {
  question: 'Для чего используется график плотности?',
  answers: [{
    text: 'Для отображения распределения вероятностей',
    count: 1
  }, {
    text: 'Для сравнения категорий данных',
    count: 0
  }, {
    text: 'Для отображения иерархий',
    count: 0
  }, {
    text: 'Для анализа временных рядов',
    count: 0
  }]
};
var resultTable = {
  preview: 'График плотности — это инструмент визуализации распределения данных за непрерывный или определенный интервал времени. Этот график является разновидностью гистограммы, где для отображения значений используется ядерное сглаживание, которое позволяет отобразить более гладкое распределение за счет сглаживания изменений параметров',
  text: 'Все верно!'
};
...
function showResult() {
  ...
  image.innerHTML = "<img src=".concat(Q_Test_Res_14_namespaceObject, ">");
  ...
  imageArticle.innerHTML = "<img src=".concat(Q_Test_Res_14_namespaceObject, ">");
