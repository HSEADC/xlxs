...
;// CONCATENATED MODULE: ./src/images/testss/Q-Test-Res-3.png
const Q_Test_Res_3_namespaceObject = __webpack_require__.p + "images/Q-Test-Res-3.a12142ae5433bfbcc3ff.png";
;// CONCATENATED MODULE: ./src/testss/test3.js

var stage = {
  question: 'Какую информацию можно получить из свечного графика?',
  answers: [{
    text: 'Годовые доходы компании',
    count: 0
  }, {
    text: 'Диапазон цен акций за n-й период',
    count: 1
  }, {
...
var resultTable = {
  preview: 'Свечной график — это один из видов финансового графика. Он показывает, как менялась цена актива за определённый временной промежуток. Такой график состоит из свечей, каждая из которых представляет одинаковый отрезок времени (таймфрейм).',
  text: 'Все верно!'
};
...
function showResult() {
  ...
  image.innerHTML = "<img src=".concat(Q_Test_Res_3_namespaceObject, ">");
  ...
  imageArticle.innerHTML = "<img src=".concat(Q_Test_Res_3_namespaceObject, ">");
