...
;// CONCATENATED MODULE: ./src/images/testss/Q-Test-Res-4.png
const Q_Test_Res_4_namespaceObject = __webpack_require__.p + "images/Q-Test-Res-4.9bb9e0de4b739977fbe4.png";
;// CONCATENATED MODULE: ./src/testss/test4.js

var stage = {
  question: 'Какую информацию можно получить из хордовой диаграммы?',
  answers: [{
    text: 'Взаимосвязи между разными категориями данных',
    count: 0
  }, {
    text: 'Изменения данных во времени',
    count: 0
  }, {
    text: 'Статистическое распределение данных',
    count: 1
  }, {
...
var resultTable = {
  preview: 'Этот вид диаграммы позволяет визуализировать внутренние отношения между объектами или сущностями. Эти взаимосвязи используются для того, чтобы продемонстрировать наличие между ними чего-то общего. Таким образом, хордовая диаграмма – идеальный инструмент для выявления сходств в пределах наборов данных или между разными группами данных.',
  text: 'Все верно!'
};
...
function showResult() {
  ...
  image.innerHTML = "<img src=".concat(Q_Test_Res_4_namespaceObject, ">");
  ...
  imageArticle.innerHTML = "<img src=".concat(Q_Test_Res_4_namespaceObject, ">");
