...
function showResult() {
  ...
  image.innerHTML = "<img src=".concat(Q_Test_Res_7_namespaceObject, ">");
  ...
  imageArticle.innerHTML = "<img src=".concat(Q_Test_Res_7_namespaceObject, ">");
