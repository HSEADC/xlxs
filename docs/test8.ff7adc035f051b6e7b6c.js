...
;// CONCATENATED MODULE: ./src/images/testss/Q-Test-Res-8.png
const Q_Test_Res_8_namespaceObject = __webpack_require__.p + "images/Q-Test-Res-8.e8b93634a5bccc80bc8b.png";
;// CONCATENATED MODULE: ./src/testss/test8.js

var stage = {
  question: 'В каком случае целесообразно использовать столбчатую диаграмму?',
  answers: [{
    text: 'Сравнение категорий данных',
    count: 1
  }, {
    ...
    text: 'Отображение организационной структуры',
    count: 0
  }]
};
var resultTable = {
  preview: 'Столбчатая диаграмма является одним из наиболее распространенных и понятных инструментов для визуализации данных. Этот тип диаграммы используется для отображения информации по категориям и является эффективным способом сравнения различных наборов данных между собой.',
  text: 'Все верно!'
};
...
function showResult() {
  ...
  image.innerHTML = "<img src=".concat(Q_Test_Res_8_namespaceObject, ">");
  ...
  imageArticle.innerHTML = "<img src=".concat(Q_Test_Res_8_namespaceObject, ">");
