...
;// CONCATENATED MODULE: ./src/images/testss/Q-Test-Res-9.png
const Q_Test_Res_9_namespaceObject = __webpack_require__.p + "images/Q-Test-Res-9.5756a8e1804cd1871ea5.png";
;// CONCATENATED MODULE: ./src/testss/test9.js

var stage = {
  question: 'Что можно определить по диаграмме рассеяния?',
  answers: [{
    text: 'Структуру организации',
    count: 0
  }, {
    text: 'Доли различных категорий',
    count: 0
  }, {
    text: 'Изменение данных во времени',
    count: 0
  }, {
    text: 'Корреляцию между двумя переменными',
    count: 1
  }]
};
var resultTable = {
  preview: 'На диаграммах рассеяния можно увидеть множество точек, разбросанных по декартовой плоскости, отражающих значения по двум переменным. Если каждой оси присвоить какую-то переменную, это поможет определить, есть ли какая-то связь между этими переменными. Паттерны, которые видны на этих диаграммах рассеяния, обычно подсказывают о типах корреляции.',
  text: 'Все верно!'
};
...
function showResult() {
  ...
  image.innerHTML = "<img src=".concat(Q_Test_Res_9_namespaceObject, ">");
  ...
  imageArticle.innerHTML = "<img src=".concat(Q_Test_Res_9_namespaceObject, ">");
