import imgHost from '../images/testss/Q-Test-Res-13.png'
const stage = {
  question: 'Какую информацию предоставляет ящик с усами (боксплот)?',
  answers: [
    { text: 'Изменения данных во времени', count: 0 },
    { text: 'Корреляцию между двумя переменными', count: 0 },
    { text: 'Иерархическую структуру', count: 0 },
    {
      text: 'Статистическое распределение данных, включая медиану и квартиль',
      count: 1
    }
  ]
}
