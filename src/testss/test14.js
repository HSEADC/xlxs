import imgHost from '../images/testss/Q-Test-Res-14.png'
const stage = {
  question: 'Для чего используется график плотности?',
  answers: [
    { text: 'Для отображения распределения вероятностей', count: 1 },
    { text: 'Для сравнения категорий данных', count: 0 },
    { text: 'Для отображения иерархий', count: 0 },
