import imgHost from '../images/testss/Q-Test-Res-3.png'
const stage = {
  question: 'Какую информацию можно получить из свечного графика?',
  answers: [
    { text: 'Годовые доходы компании', count: 0 },
    { text: 'Диапазон цен акций за n-й период', count: 1 },
    { text: 'Количество сотрудников в компании', count: 0 },
    { text: 'Прогнозы аналитиков', count: 0 }
  ]
}

const resultTable = {
  preview:
    'Свечной график — это один из видов финансового графика. Он показывает, как менялась цена актива за определённый временной промежуток. Такой график состоит из свечей, каждая из которых представляет одинаковый отрезок времени (таймфрейм).',
  text: 'Все верно!'
}
