import imgHost from '../images/testss/Q-Test-Res-4.png'
const stage = {
  question: 'Какую информацию можно получить из хордовой диаграммы?',
  answers: [
    { text: 'Взаимосвязи между разными категориями данных', count: 0 },
    { text: 'Изменения данных во времени', count: 0 },
    { text: 'Статистическое распределение данных', count: 1 },
