import imgHost from '../images/testss/Q-Test-Res-5.png'
const stage = {
  question: 'Для чего используется блок-схема?',
  answers: [
    { text: 'Для анализа данных', count: 0 },
    { text: 'Для отображения последовательности шагов в процессе', count: 1 },
    { text: 'Для представления временных рядов', count: 0 },
    { text: 'Для построения демографических прогнозов', count: 0 }
  ]
}

const resultTable = {
  preview:
    'Блок-схема — это тип диаграммы, который представляет алгоритм или процесс, показывая шаги в виде блоков различных форм, соединенных стрелками, которые указывают направление потока. Каждая форма блока имеет свое значение, что позволяет точно определить тип операции или действия.',
  text: 'Все верно!'
}
