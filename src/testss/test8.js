import imgHost from '../images/testss/Q-Test-Res-8.png'
const stage = {
  question: 'В каком случае целесообразно использовать столбчатую диаграмму?',
  answers: [
    { text: 'Сравнение категорий данных', count: 1 },
    { text: 'Анализ временных рядов', count: 0 },
    { text: 'Прогнозирование трендов', count: 0 },
    { text: 'Отображение организационной структуры', count: 0 }
  ]
}

const resultTable = {
  preview:
    'Столбчатая диаграмма является одним из наиболее распространенных и понятных инструментов для визуализации данных. Этот тип диаграммы используется для отображения информации по категориям и является эффективным способом сравнения различных наборов данных между собой.',
  text: 'Все верно!'
}
