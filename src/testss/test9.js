import imgHost from '../images/testss/Q-Test-Res-9.png'
const stage = {
  question: 'Что можно определить по диаграмме рассеяния?',
  answers: [
    { text: 'Структуру организации', count: 0 },
    { text: 'Доли различных категорий', count: 0 },
    { text: 'Изменение данных во времени', count: 0 },
    { text: 'Корреляцию между двумя переменными', count: 1 }
  ]
}
